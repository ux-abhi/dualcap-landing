export default function Nav() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50" style={{ backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", background: "rgba(6,6,13,0.75)", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="btn-bmc hidden sm:flex items-center gap-1.5"
          >
            ☕ Buy me a coffee
          </a>
          <a
            ...
            style={{ padding: "9px 18px", fontSize: "13px", borderRadius: "9px" }}
          >
